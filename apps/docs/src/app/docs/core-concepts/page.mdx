export const metadata = {
  title: 'Core Concepts',
  description: 'Understand the architecture and core concepts of react-access-control.',
};
...
react-access-control is built around a single `<AccessProvider>` that initializes several specialized engines:
...
react-access-control provides both declarative components and imperative hooks:
...
```ts
import { defineAccess, mergeConfigs } from 'react-access-control';
