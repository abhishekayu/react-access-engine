export const metadata = {
  title: 'Examples',
  description: 'Real-world usage examples for react-access-control.',
};

# Examples

Real-world patterns and recipes for using react-access-control in production applications.

## SaaS Dashboard with Plan Gating

```tsx
import { defineAccess, AccessProvider, Can, Feature, AccessGate } from 'react-access-control';
...
```tsx
import { createAnalyticsPlugin, defineAccess } from 'react-access-control';
...
// app/admin/page.tsx
('use client');
import { PermissionGuard } from 'react-access-control';
...
```tsx
import { defineAccess, useRemoteConfig, AccessProvider, Feature } from 'react-access-control';
