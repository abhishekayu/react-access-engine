...
| `roles`             | `string[]`       | Enable only for these roles                 |
| `plans`             | `string[]`       | Enable only for these plans                 |
| `environments`      | `string[]`       | Enable only in these environments           |
...
```tsx
import { Feature } from 'react-access-control';
...
```tsx
import { FeatureToggle } from 'react-access-control';
...
```tsx
import { useFeature } from 'react-access-control';
