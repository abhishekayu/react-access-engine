export const metadata = {
  title: 'Introduction',
  description: 'Learn about react-access-engine — unified access control for React applications.',
};

# Introduction

**react-access-engine** is a unified, type-safe access control library for React that combines RBAC, ABAC,
...
```tsx
import { defineAccess, AccessProvider, Can, Feature } from 'react-access-engine';
