...
function DocumentCard({ doc, currentUserId }) {
  const resource = {
    ownerId: doc.ownerId,
  ...
  return _jsxs('div', {
    style: { ...card, background: '#fafafa' },
    children: [
      _jsx('h3', { style: { margin: '0 0 8px' }, children: doc.title }),
      _jsxs('div', {
        style: { fontSize: 13, color: '#666', marginBottom: 8 },
        children: ['Owner: ', doc.ownerId, ' | Dept: ', doc.department, ' | Status: ', doc.status],
      }),
      _jsx(Can, {
        perform: 'documents:read',
        children: _jsx('span', {
      ...
      _jsx(Can, {
        perform: 'documents:delete',
        fallback: _jsx('span', { style: { color: '#999' }, children: '\uD83D\uDD12 Delete' }),
        children: _jsx('span', {
          style: { color: '#f44336' },
          children: '\uD83D\uDDD1\uFE0F Delete',
        }),
  ...
  return _jsxs('div', {
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('h3', { style: { margin: '0 0 8px' }, children: 'Current User' }),
          _jsxs('p', {
            style: { margin: 0 },
            children: [
              'ID: ',
              _jsx('strong', { children: user.id }),
              ' | Roles: ',
              _jsx('strong', { children: roles.join(', ') }),
              user.attributes?.department &&
                _jsxs(_Fragment, {
                  children: [
                    ' | Department: ',
                    _jsx('strong', { children: user.attributes.department }),
                  ],
                }),
            ],
          }),
      ...
      _jsx('h2', { children: 'Policy Evaluation Results' }),
      _jsx(PolicyCheck, {
      ...
      _jsx('h2', { children: 'Documents' }),
      documents.map((doc) => _jsx(DocumentCard, { doc: doc, currentUserId: user.id }, doc.id)),
    ],
  });
}
const users = [
...
export function App() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('h1', { children: 'ABAC Policies Example' }),
      _jsx('p', {
        children:
          'Switch users to see how attribute-based policies change access. Policies evaluate ownership, department membership, document status, and more.',
      }),
      _jsxs('label', {
        ...
        children: [
          ...
          _jsx('select', {
            ...
            children: users.map((u, i) => _jsx('option', { value: i, children: u.label }, u.id)),
          }),
        ],
      }),
      _jsx(AccessProvider, { config: config, user: user, children: _jsx(PolicyDashboard, {}) }),
    ],
  });
}
