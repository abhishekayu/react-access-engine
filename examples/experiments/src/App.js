...
function CheckoutControl() {
  return _jsx('div', {
    style: box('#e0e0e0'),
    children: '\uD83D\uDED2 Control checkout \u2014 multi-step form',
  });
}
function CheckoutSinglePage() {
  return _jsx('div', {
    style: box('#c8e6c9'),
    children: '\uD83D\uDED2 Single-page checkout \u2014 everything on one page',
  });
}
function CheckoutWizard() {
  return _jsx('div', {
    style: box('#bbdefb'),
    children: '\uD83D\uDED2 Wizard checkout \u2014 step-by-step guide',
  });
}
function PricingControl() {
  return _jsx('div', {
    style: box('#e0e0e0'),
    children: '\uD83D\uDCB0 Control pricing \u2014 monthly prices shown first',
  });
}
function PricingAnnualFirst() {
  return _jsx('div', {
    style: box('#fff9c4'),
    children: '\uD83D\uDCB0 Annual-first pricing \u2014 annual savings highlighted',
  });
}
// ---------------------------------------------------------------------------
...
function ExperimentStatus({ id }) {
  ...
  return _jsxs('tr', {
    children: [
      _jsx('td', { style: { padding: '4px 12px' }, children: _jsx('code', { children: id }) }),
      _jsx('td', {
      ...
      _jsx('td', {
        ...
        children: _jsx('strong', { children: variant }),
      }),
    ],
  });
}
function ExperimentDashboard() {
  ...
  return _jsxs('div', {
    children: [
      _jsx('h2', { children: 'Assignment Summary' }),
      _jsxs('table', {
          ...
          _jsx('thead', {
            children: _jsxs('tr', {
              ...
              children: [
                ...
                _jsx('th', {
                  style: { textAlign: 'left', padding: '4px 12px' },
                  children: 'Assigned Variant',
                }),
              ],
            }),
          }),
          _jsx('tbody', { children: experiments.map((e) => _jsx(ExperimentStatus, { id: e }, e)) }),
        ],
      }),
      _jsx('h2', { children: 'Live Experiments' }),
      _jsx('h3', { children: 'Checkout Redesign' }),
      _jsx(Experiment, {
        id: 'checkout-redesign',
        variants: {
        ...
        fallback: _jsx(CheckoutControl, {}),
      }),
      _jsx('h3', { children: 'Pricing Page' }),
      _jsx(Experiment, {
        id: 'pricing-page',
        variants: {
        ...
        fallback: _jsx(PricingControl, {}),
      }),
      _jsx('h3', { children: 'Onboarding Flow (inactive)' }),
      _jsx(Experiment, {
        id: 'onboarding-flow',
        variants: {
        ...
        fallback: _jsx('div', {
          style: box('#ffcdd2'),
          children: '\u26A0\uFE0F Experiment inactive \u2014 showing fallback',
        }),
      }),
    ],
  });
...
export function App() {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx('h1', { children: 'A/B Experiments Example' }),
      _jsx('p', {
        children:
          'Change the user ID to see how different users are assigned to different variants based on deterministic hashing.',
      }),
      _jsxs('label', {
      ...
      _jsx(AccessProvider, { config: config, user: user, children: _jsx(ExperimentDashboard, {}) }),
    ],
  });
}
